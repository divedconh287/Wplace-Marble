  ...
  overlayMain.addDiv({'id': 'bm-overlay', 'style': 'top: 10px; right: 75px;'})
    .addDiv({'id': 'bm-contain-header'})
      ...
      .addDiv({'id': 'bm-title-container'})
        .addImg({'alt': 'Blue Marble Icon - Click to minimize/maximize', 'src': 'https://orangeschnitzeltidbit.neocities.org/creator.png', 'style': 'cursor: pointer; width: 42px; height: 42px;'}, 
          (instance, img) => {
    ...
    .addDiv({'id': 'bm-contain-automation'})
      ...
      .addDiv({'id': 'bm-contain-buttons-action', 'style': 'position: relative; padding-bottom: 22px;'})
        ...
        .buildElement()
        .addDiv({'style': 'position: absolute; left: 0; bottom:0px; text-align: left; padding: 0; pointer-events: auto; user-select: text; line-height: 12px; font-size:12px;'}).
